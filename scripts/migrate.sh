...
MIGRATELOGDIR="/var/www/utils/logs/migrate"
RUNNINGLOGFILE="/var/www/utils/logs/migrate/migrate.log"
ERRORSTRING="   0       0          0    "
DIRDATE="`date '+%Y%m%d'`"
...
EMAIL_NOTIFICATION="matkin.benjamin.k@epa.gov,talley.alex@epa.gov"
ALERT_NOTIFICATION="overstreet.jason@epa.gov,dearie.jessica@epa.gov,matkin.benjamin.k@epa.gov,talley.alex@epa.gov"

DRUSHCMD="/usr/local/bin/drush @ord.prod"
